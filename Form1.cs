...
namespace _024_SensorMonitoring
{
    public partial class Form1 : Form
  {
        ...
        private int xCount = 30; // 차트에 표시되는 데이터 갯수
      ...
      foreach (var port in SerialPort.GetPortNames())
       ...
       comboBox1.Text = "Select Port";
        ...
        private void InitSetting()
        {
            ...
            btnPortValue.BackColor = Color.Pink;
        ...
        static int skip = 0;  //처음 받은 값 3개를 skip하기 위함
        ...
        private void ShowValue(string s)
        {
            ...
            double temp = int.Parse(sub[0]);
            double humi = int.Parse(sub[1]);
